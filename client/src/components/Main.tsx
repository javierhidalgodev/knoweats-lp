const Main = () => {
    return (
        <section id='main' className='relative mt-44 mx-auto px-6 lg:px-2 max-w-5xl flex max-md:flex-col gap-6'>
            <div className={`main__description relative max-md:p-10 basis-1/2 max-md:bg-[url('/cenital-mesa-platos-knoweats.webp')] bg-cover max-md:text-white max-md:before:bg-black max-md:before:bg-opacity-60 before:w-full before:h-full before:absolute before:top-0 before:left-0 before:-z-[5] before:backdrop-blur-sm z-[5] rounded-xl overflow-hidden`}>
            ...
            <div className='basis-1/2 max-md:hidden'>
              <img src='/cenital-mesa-platos-knoweats.webp' alt='Imagen de cómida de la sección principal' className='main__img rounded-xl' />
            </div>
          </section>
    )
}
